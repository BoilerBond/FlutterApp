...
class _EventRoomScreenState extends State<EventRoomScreen> {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(curUser!.currentEventQuestion ?? ""),
  ...
  Future<void> _showGuessPopup() async {
    ...
    await showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text("Guess your match's answer"),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(curUser!.currentEventQuestion ?? ""),
            ...
            TextField(
              ...
              decoration:
              const InputDecoration(hintText: "Type your guess here..."),
            ),
          ],
        ),
        actions: [
            ...
            child: Column(
              ...
              children: [
                ...
                updatedScoreInfo != null &&
                    updatedScoreInfo['averageScore'] != null
                    ? Text(
                    "Your Avg Match Score: ${updatedScoreInfo['averageScore']}%")
            ...
            child: Column(
              ...
              children: [
                ...
                updatedScoreInfo != null &&
                    ...
                    : const Text("Match score not available yet."),
                SizedBox(height: 20),
                if (rankPercentile == null && !_rankChecked)
                  ElevatedButton(
                    onPressed: () async {
                      await _calculateRankLocally();
                      setState(() {
                        _rankChecked = true;
                      });
                    },
                  ...
                  Text('Your Match Ranking: Top ${rankPercentile ?? 0}%'),
                SizedBox(height: 20),
                ElevatedButton(
